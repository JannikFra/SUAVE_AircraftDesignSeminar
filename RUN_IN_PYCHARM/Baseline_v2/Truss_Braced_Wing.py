...
def base_analysis(vehicle, iteration_setup):
    ...
    weights.settings.weight_reduction_factors.fuselage = 0.1 #- 0.06 # +6 percent for high wing, -10 percent for CFRP
...
if __name__ == '__main__':
    ...
    parameters.thickness_to_chord = 0.11
    parameters.design_cruise_altitude = 36_000 * Units.ft
    parameters.design_cruise_mach = 0.82
    parameters.sweep_quarter_chord = 28 * Units.deg
    parameters.thrust_loading = 0.24
    parameters.drag_counts = 0e-4 # 19e-4
    Baseline(parameters)
