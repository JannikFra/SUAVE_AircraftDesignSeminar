...
def vehicle_setup(iteration_setup):
    ...
    propulsor.origin            = [[48.0, 6.0, 1.0],[48.0, -6.0, 1.0]]
    ...
    landing_gear.main_strut_length        = 1.9 * Units.m       # TODO abhängigkeit modellieren
    landing_gear.nose_strut_length        = 1.9 * Units.m       # TODO abhängigkeit modellieren
