...
from RUN_IN_PYCHARM.Conventional_Configuration.vehicle_setup import vehicle_setup, configs_setup
from RUN_IN_PYCHARM.Conventional_Configuration.mission_setup import mission_setup
...
if __name__ == '__main__':
    ...
    parameters.aspect_ratio = 9.988
    parameters.thickness_to_chord = 0.13
    parameters.design_cruise_altitude = 33_000. * Units.ft
    ...
    print(F_m_TOC)
    parameters.thrust_loading = 0.228   # F_m_TOC[0][0]
