...
from RUN_IN_PYCHARM.Reference_B737.Boeing_737 import vehicle_setup, configs_setup
...
def base_analysis(vehicle):
    ...
    avl_files_path = os.path.join(tool_path, "RUN_IN_PYCHARM/Reference_B737/avl_files")
    aero_training_path = os.path.join(tool_path, "RUN_IN_PYCHARM/Reference_B737/cruise_aero_data.txt")
    stability_training_path = os.path.join(tool_path, "RUN_IN_PYCHARM/Reference_B737/cruise_stability_data.txt")
