...
from RUN_IN_PYCHARM.Truss_Braced_Wing_Conventional_Tail.vehicle_setup import vehicle_setup, configs_setup
from RUN_IN_PYCHARM.Truss_Braced_Wing_Conventional_Tail.mission_setup import mission_setup
...
def base_analysis(vehicle):
    ...
    weights.settings.weight_reduction_factors.fuselage = -0.06
