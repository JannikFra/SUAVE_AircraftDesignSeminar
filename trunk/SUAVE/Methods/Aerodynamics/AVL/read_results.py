        ...
        with open(case.aero_result_filename_1,'r') as stab_der_vile:
            ...
            if num_ctrl != 0: 
                for ctrl_idx in range(num_ctrl):
                    ...
                    ctrl_surf.CL                  = float(lines[52+num_ctrl][(20*ctrl_idx + 27):(20*ctrl_idx + 36)].strip())
                    ctrl_surf.CY                  = float(lines[53+num_ctrl][(20*ctrl_idx + 27):(20*ctrl_idx + 36)].strip())
                    ctrl_surf.Cl                  = float(lines[54+num_ctrl][(20*ctrl_idx + 27):(20*ctrl_idx + 36)].strip())
                    ctrl_surf.Cm                  = float(lines[55+num_ctrl][(20*ctrl_idx + 27):(20*ctrl_idx + 36)].strip())
                    ctrl_surf.Cn                  = float(lines[56+num_ctrl][(20*ctrl_idx + 27):(20*ctrl_idx + 36)].strip())
                    ctrl_surf.CDff                = float(lines[57+num_ctrl][(20*ctrl_idx + 27):(20*ctrl_idx + 36)].strip())
                    ctrl_surf.e                   = float(lines[58+num_ctrl][(20*ctrl_idx + 27):(20*ctrl_idx + 36)].strip())
